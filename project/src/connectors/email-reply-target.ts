...
/**
 * The recovered reply target for an email. A reply must go to the ORIGINAL correspondent, never the forwarder
...
export interface ReplyTarget {
   ...
   * verify before sending. Also false when unresolved. */
...
export function resolveReplyTarget(
  ...
  //: shown as a suggestion the user must confirm before sending.
