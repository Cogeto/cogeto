-- Migration 0035 — remove the task subsystem (V2.0 item 3.1).
--
...
-- `source_type = 'task_conclusion'` memories. Those memories
...
-- see and scripts/dev/erase-task-conclusions.mjs. Dropping the
-- table without that would strand provenance and trip the sweep's orphan arm
--. The guard below refuses to drop while such memories remain,
...
-- adoption INTO ( →); the skill definition
