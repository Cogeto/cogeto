-- Migration 0027 — web research core (Priority 5 Part A;/0043).
--
...
-- RETAINED here as the complete source of record (retention:
-- clean text + URL by default; the raw HTML object is optional), and the normal
-- ingestion pipeline extracts memories whose provenance points at this row
...
CREATE TABLE web_page (
  ...
  -- of record and the pipeline's extraction input.
