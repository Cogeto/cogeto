...
(the specification): consequential actions persist as rows moving through
...
(drafting), `identity` (who approves). Emits/consumes domain events via the outbox (spec §15.4).
