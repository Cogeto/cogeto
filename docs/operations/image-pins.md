...
| `docker-compose.yml` | `postgres:17-alpine`, `qdrant/qdrant:v1.19.0`, `minio/minio:RELEASE.2025-09-07T16-13-09Z`, `minio/mc:RELEASE.2025-08-13T08-35-41Z`, `busybox:stable`, `ghcr.io/zitadel/zitadel:v3.4.15`, `searxng/searxng` (dated build tag), `node:24-alpine` (zitadel-init) |
