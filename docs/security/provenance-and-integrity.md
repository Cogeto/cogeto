...
- **The mid-flight race:** a source deleted while its ingestion job is
...
- **The missing constraint:** "no orphans, ever" was a convention, not
...
The standard set for this was "impossible, or detected within one sweep cycle." Mechanisms
