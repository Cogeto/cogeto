...
const DOMAIN_MODULES =
  'chat|memory|ingestion|retrieval|agents|email|files|notes|research|settings|skills|passport|attention|operations|sources|imports|reports|providers|connectors|confluence|projects|spaces';
